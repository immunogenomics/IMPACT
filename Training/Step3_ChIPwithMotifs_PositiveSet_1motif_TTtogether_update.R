...
train_df <- read.table("train_df.txt", sep = "\t", header = F, stringsAsFactors = FALSE)
instances <- read.table("TFs.findinstances.txt", sep = "\t", header = T, stringsAsFactors = FALSE)
MotifLibrary <- read.table("MotifThresholdList.txt", sep = "\t", header = F, stringsAsFactors = FALSE)
...
write.table(train_test_peaks, "train_test_positive_bed.txt", sep = "\t", quote = F, row.names = FALSE, col.names = FALSE)
